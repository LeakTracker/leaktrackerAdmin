<template>
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? 'الجداول' : 'Reports'"
        >
          <template v-slot:icon>
            <i
      ...
      <li class="nav-item">
        <sidenav-item
          url="/accounts"
          :class="getRoute() === 'accounts' ? 'active' : ''"
          :navText="this.$store.state.isRTL ? 'الجداول' : 'Accounts'"
        >
          <template v-slot:icon>
      ...
      <!-- <li class="nav-item">
        <sidenav-item
          ...
          :navText="this.$store.state.isRTL ? 'الجداول' : 'Settings'"
        >
          <template v-slot:icon>
  ...
  <div class="pt-3 mx-3 mt-5 sidenav-footer">
    <button @click = "$store.dispatch('logout')" type="button" class="btn btn-danger w-100">Logout</button>
  </div>
</template>
<script>
