                                  ...
                                  <tr v-for="(data, index) in reports" :key="index" :value="data">
                                      ...
                                      <td class="align-middle text-center">
                                          <button class="btn" data-bs-toggle="modal" data-bs-target="#addModal"
                                              @click="selectEditData(data.document_id, data.name, data.email, data.contact_number, data.occupation, data.department, data.status, data.image_link, id_lists[index], data.water_loss)"><i
...
import { collection, addDoc, getDocs, updateDoc, deleteDoc, doc, orderBy, query } from "firebase/firestore";
  ...
  export default {
    ...
    methods: {
        ...
        selectEditData(id, name, email, contact_number, occupation, department, status, image_link, docId, water_loss) {
